// import { REGISTER_REQUEST } from "../Authentication/ActionType"
...
export const getAllRestaurantsAction = (token) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("all restuarant error:: ", error);
...
export const getRestaurantByUserId = (jwt) => { 
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("get restaurant by user id catch error: ", error);
...
export const createRestaurant = (reqData) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("created restaurant: catch error ", error);
        }
    }
}
    ...
    return async (dispatch) => {
        ...
        try {
            const res = await api.post(`api/admin/events/restaurant/${restaurantId}`,
                    ...
                    dispatch({ type: CREATE_EVENTS_SUCCESS, data: res.data })
        } catch (error) {
            console.log("error in creating events:: ", error);
            dispatch({ type: CREATE_EVENTS_FAILURE, data: error })            
        }
    }
}
...
export const getRestaurantsEvents = ({ restaurantId, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("error in getting restaurant events, ", error);
...
export const createCategoryAction = ({ reqData, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("create category events, ", res.data);
...
export const getRestaurantsCategory = ({ jwt, restaurantId }) => {
    return async (dispatch) => {
        ...
        try {
            const res = await api.get(`api/category/restaurant`,
                        {
                            headers: {
                                Authorization: `Bearer ${jwt}`
                            }
